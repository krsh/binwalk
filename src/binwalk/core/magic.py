...
class Magic(object):
    ...
    def __init__(self, exclude=None, include=None, invalid=False):
        """
        Class constructor.
        ...
        # Regex rule to replace backspace characters (and the preceeding character)
